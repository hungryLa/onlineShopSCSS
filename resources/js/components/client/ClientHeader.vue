...
import ThemeButton from "@/components/ui/theme-button/theme-button.vue";
...
<template>
    <header class="header header-hidden bg-background" ref="header">
        <div class="header__inner">
            <div class="header__icon text-primary">
                <svg width="101" height="42" viewBox="0 0 101 42" fill="none" xmlns="http://www.w3.org/2000/svg"
                     class="h-[24px] w-[auto] text-highlights-primary lg:h-[30px] lg:w-[auto] transform-gpu">
                    <path
...
.header {
    @apply z-30 sticky top-0 mb-2 min-h-[77px] p-4 border-b-2 border-border;
