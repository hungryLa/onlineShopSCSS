    ...
    <header class="header header-hidden" ref="header">
        <div class="header__inner">
            ...
            <div class="header__search_input">
                ...
                <input type="text" class="header__nav__input" />
                <div></div>
            </div>
...
<style lang="scss" scoped>
    .header{
        @apply sticky top-0 mb-2 bg-white min-h-[77px] p-4 border-b-2;
        ...
        &__icon {
            @apply h-fit text-[#5433eb];
        }

        &__search_input{
            @apply max-w-[500] bg-[#f2f4f5] w-[500px] flex text-muted-foreground rounded-lg items-center relative;
